...
class SocietyLoginRequest(BaseModel):
    societyCode: str = Field(min_length=1, max_length=64)
    password: str = Field(min_length=1, max_length=128)

class SocietyLoginResponse(TokenPair):
    society: dict
...
class FederationLoginResponse(TokenPair):
    federation: dict
