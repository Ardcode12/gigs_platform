        ...
        <View style={styles.modalOverlay}>
          <View style={styles.receiptContainer}>
            ...
            <View style={styles.receiptBody}>
              ...
              <Text style={styles.receiptInvoiceNo}>{invoiceNum}</Text>
              <Text style={styles.receiptDate}>Date: {todayStr}</Text>

              <View style={styles.receiptDivider} />

              <Text style={styles.receiptSectionHeader}>Technician Details</Text>
              <Text style={styles.receiptWorker}>{workerName}</Text>
              <Text style={styles.receiptWorkerTrade}>{workerTrade}</Text>

              <View style={styles.receiptDivider} />

              <Text style={styles.receiptSectionHeader}>Services & Charges</Text>
              {serviceItems.map((it, idx) => (
                <View key={it.id || idx} style={styles.receiptItemRow}>
